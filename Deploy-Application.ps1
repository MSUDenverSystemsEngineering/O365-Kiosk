...
Try {
	...
	[string]$appVersion = '2102 - Public Kiosk'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$exitCode = Execute-Process -Path "$dirFiles\setup.exe" -Parameters "/configure O365-2102-Kiosk.xml" -WindowStyle "Hidden" -PassThru -WaitForMsiExec
